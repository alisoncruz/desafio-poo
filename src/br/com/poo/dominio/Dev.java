...
public class Dev {
    ...
    public void inscreverBootcamp(Bootcamp bootcamp) {
        this.getConteudosIncritos().addAll(bootcamp.getConteudos());
    ...
    public void progredir() {
        ...
        if (conteudo.isPresent()) {
            ...
            System.err.println("Não há inscrições");
        }
    ...
    public void exibirCursos(){
        this.getConteudosIncritos().stream().filter(conteudo -> conteudo instanceof Curso)
